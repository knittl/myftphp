...
// user => (saltedHash(password), home-dir[w/o ending slash], language name, theme name)
// ******
// USE ./myft.php?a=setup TO GENERATE ACCOUNTS + PASSWORDS
$accounts = array(
	'myftphp' => array(
		// createSaltedHash('myftphp'):
		'pass'  => 'bcaaaa7610531338957b118c803f56c07198475e:1fbf97e3ca50a41bd42911fcad6025de',
		'home'  => '.',
		'lang'  => 'english',
		'theme' => 'light',
	),
